...
MycroftAiGnomeBox.prototype = {
	...
	let _installButton = new St.Button ({ label: "Install Dependencies", style_class:"button" });
	_installButton.connect ('clicked', Lang.bind(this, _installMycRunnerd));
	...
	_startButton.hide();
	_stopButton.show();
	_installButton.destroy();
	    }

	function _installMycRunnerd() {
	mycRunner.install();
	this._runnerdLabel.set_text ("Installed: Start Service ");
