...
MycroftAiGnomeBox.prototype = {
	...
	this._getnotificationinput = new St.Label({style_class: 'query'});
	this._getnotificationinput.set_text('Query Input:');
	...
	box.add(this._getnotificationinput, {expand:true});

	this._getnotificationoutput = new St.Label({style_class: 'query'});
	this._getnotificationoutput.set_text('Query Output:');
	...
	box.add(this._getnotificationoutput);
