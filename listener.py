...
class AudioConsumer(threading.Thread):
    ...
    def _create_remote_stt_runnable(self, audio, utterances):
		...
		bus = dbus.SessionBus()
		remote_object = bus.get_object("org.gnome.Shell","/com/mycroftaignome/MycroftGnomeResult")  
		getvoiceQuery = remote_object.setText("Your device is not registered yet. To start pairing, login at cerberus.mycroft.ai", dbus_interface = "com.mycroftaignome.MycroftAiGnomeBox")
		...
		bus = dbus.SessionBus()
		remote_object = bus.get_object("org.gnome.Shell","/com/mycroftaignome/MycroftGnomeResult")  
		getvoiceQuery = remote_object.setText(text, dbus_interface = "com.mycroftaignome.MycroftAiGnomeBox")
