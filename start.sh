...
case $1 in
	...
	"guignome") SCRIPT=${TOP}/mycroft/client/gui/guignome.py ;;
	...
	*) echo "Usage: start.sh [service | skills | skill_container | voice | cli | guignome | audiotest | collector | unittest | enclosure | pairing | sdkdoc ]"; exit ;;
esac
